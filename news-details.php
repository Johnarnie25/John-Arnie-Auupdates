               ...
               <div class="card border-0">
                  <div class="card-body">
                    <a class="badge bg-success text-decoration-none link-light" href="category.php?catid=<?php echo htmlentities($row['cid'])?>" style="color:#fff"><?php echo htmlentities($row['category']);?></a>
                     ...
                     <?php endif;?>
                     <p><strong>Share:</strong> <a href="https://www.facebook.com/phinmaau?u=<?php echo $currenturl;?>" target="_blank">Facebook</a> | 
                       
                        <a href="https://au.phinma.edu.ph?mini=true&amp;url=<?php echo $currenturl;?>" target="_blank">Website</a>  <b>Visits:</b> <?php print $visits; ?>
                     </p>
                     <hr>
                     <img class="img-fluid w-100" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>" style="width: 400px; height: 700px;">
