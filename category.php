...
<html lang="en">
  ...
  <head>
    ...
    <title>Phinma Araullo University | Category</title>
...
<div class="col-md-2 mt-5">
              <!-- Categories Widget -->
               <div class="card my-4 border-0" >
                  <h5 class="card-header bg-white border-0">ANNOUNCEMENT LIST</h5>
                  <div class="card-body">
                     <div class="row">
                        <div class="col-lg-12">
...
?>
<h1><?php echo htmlentities($row['category']);?> Announcement</h1>
          <div class="card mb-4">
       <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>" style="width: 920px; height: 700px;">
            <div class="card-body">
