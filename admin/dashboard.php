            ...
            <div class="col-md-4">
               <div class="card-box h-100">
                  <div class="card-header">
                     <h2 class="card-title mb-2">Welcome Phinma Admin.</h2>
                     <span class="d-block mb-4 text-nowrap">Araullo University</span>
                  </div>
                  <br><br>
                  ...
                  <div class="card-body">
                     <div class="row ">
                        <div class="col-md-6">
                           <h1 class="display-6 text-primary mb-2 pt-4 pb-1">74+ Years of Services</h1>
                           <small class="d-block mb-3">In <br>PHINMA Araullo University
(Main Campus)<br>PHINMA Araullo University
(South Campus)<br>PHINMA Araullo University
(San Jose Campus)</small>
                           <br>
                           <br>
                           <a href="index.php" target="a_blank" class="btn btn-sm btn-primary">Visit Website</a>
                        </div>
                        <div class="col-md-6">
                           <img src="assets/images/favicon.png" width="140" height="150" class="rounded-start">
                        </div>
                     </div>
                  </div>
               </div>
...
<script>
   var options = {
     ...
     colors: ['#211C6A', '#B31312', '#343434'], // Change the colors here
     plotOptions: {
       radialBar: {
         dataLabels: {
           name: {
             fontSize: '40px',
             style: {
               colors: ['#211C6A', '#B31312', '#343434'] // Set label colors here
             }
           },
           value: {
             fontSize: '16px',
     ...
     labels: ['People', 'Category', 'Announcement'],
   };
