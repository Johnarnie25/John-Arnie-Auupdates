...
<?php endif;?>
  ...
  <li class="has_sub">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-calendar"></i> <span> Calendar</span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="schedule.php">Calendar Schedule</a></li>
                                    <li><a href="confirmationschedule.php">Manage Posts Schedule</a></li>
